package com.motang.generator.util;

import com.google.common.base.Preconditions;
import com.motang.generator.constant.GeneratorConstant;
...
public class FileUtil {
    ...
    public static void download(String filePath, String fileName, Boolean delete, HttpServletResponse response) throws Exception {
        ...
        response.setHeader(HttpHeaders.CONTENT_DISPOSITION, "attachment;fileName=" + java.net.URLEncoder.encode(fileName, GeneratorConstant.UTF8));
        response.setContentType(MediaType.MULTIPART_FORM_DATA_VALUE);
        response.setCharacterEncoding(GeneratorConstant.UTF8);
    ...
    private static Boolean fileTypeIsValid(String fileType) {
        ...
        return ArrayUtils.contains(GeneratorConstant.VALID_FILE_TYPE, fileType);
    }
